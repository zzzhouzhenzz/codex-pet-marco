...
- `pet/spritesheet.webp`: the verified 1536 x 2288 transparent cool-cream v2 spritesheet.
...
Marco v2 uses original character art created for this project from the cream French bulldog photo reference. The repository does not add a license unless the owner explicitly chooses one.

## Verification gates

- Manifest ID, display name, sprite path, and kind match the package.
- The spritesheet is 1536 x 2288 WebP with alpha support and declares `spriteVersionNumber: 2`.
